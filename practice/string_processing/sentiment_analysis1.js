...
function sentiment(text) {
  var positiveRegex = new RegExp('\\b' + positiveWords.join('\\b|') + '\\b', 'g');
  var negativeRegex = new RegExp('\\b' + negativeWords.join('\\b|') + '\\b', 'g');
  var positiveList = text.match(positiveRegex);
  var negativeList = text.match(negativeRegex);
  var sentiment = determineSentiment(positiveList, negativeList); 
  return displayResults(positiveList, negativeList, sentiment);
}

function displayResults(positive, negative, outcome) {
  ...
  console.log('The sentiment of the text is ' + outcome);
}

function determineSentiment(positive, negative) {
