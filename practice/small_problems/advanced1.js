...
var template1 = 'The {verb} {adjective} {noun} {adverb}';

function madlibs(template) {
  var noun = ['crowd', 'fork', 'guitar', 'twig', 'smoke', 'stamp'];
  var verb = ['turn', 'deceive', 'force', 'bang', 'scare', 'launch', 'whisper'];
  var adjective = ['husky', 'seemly', 'abundant', 'damp', 'glorius', 'victorious', 'uselss', 'busy'];
  var adverb = ['sweetly', 'scarcely', 'exactly', 'definitely', 'terribly'];
  
  function getRandom(match) {
  ...
  return template.replace(/{\w+}/g, getRandom);
}
